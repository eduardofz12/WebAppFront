...
@Component({
  selector: 'app-partner-entity-search',
  templateUrl: './partner-entity-search.component.html',
  styleUrls: ['./partner-entity-search.component.css']
})
export class PartnerEntitySearchComponent implements OnInit {
